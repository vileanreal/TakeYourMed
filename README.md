...
## Highlights
- Alarm-style, high-priority reminders with a bundled alarm-volume tone that continues while Android is locked
- Notification-shade Taken and 10-minute Snooze actions that do not bring the app forward
...
The Android alarm tone is generated by `tool/generate_alarm_sound.dart` and bundled as a raw resource. Android alarm volume must be audible; user-muted notification channels and Do Not Disturb rules remain under system control.
